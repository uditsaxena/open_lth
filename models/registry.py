...
from models import cifar_resnet, cifar_vgg, mnist_lenet, imagenet_resnet, lenet5_mnist
from models import bn_initializers, initializers
from platforms.platform import get_platform

registered_models = [mnist_lenet.Model, cifar_resnet.Model, cifar_vgg.Model, imagenet_resnet.Model, lenet5_mnist.Model]
